...
namespace Emotiv
{
    ...
    public class EmoState : ICloneable
    {
        ...
        /// </summary>
        /// <returns>valence level (0.0 to 1.0)</returns>
        public Single AffectivGetValenceScore()
        {
            return EdkDll.ES_AffectivGetValenceScore(hEmoState);
        }
        /// <summary>
      ...
      /// <summary>
        ...
        /// <param name="minScale,maxScale"> return scale range</param>
        /// <returns></returns>
        public void AffectivGetValenceModelParams(out Double rawScore, out Double minScale, out Double maxScale)
        {
            EdkDll.ES_AffectivGetValenceModelParams(hEmoState, out rawScore, out minScale, out maxScale);
        }
    }
}
