...
namespace Emotiv
{
    public class EdkDll
    {
        ...
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EngineLocalConnect")]
        static extern Int32 Unmanged_EE_EngineLocalConnect(String security);
        ...
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfStart")]
        static extern Int32 Unmanaged_EE_EdfStart();
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfStop")]
        static extern Int32 Unmanaged_EE_EdfStop();
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfSeek")]
        static extern Int32 Unmanaged_EE_EdfSeek(UInt32 sec);
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfGetTotalTime")]
        static extern Int32 Unmanaged_EE_EdfGetTotalTime(UInt32 totalTime);
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfStartSaving")]
        static extern Int32 Unmanaged_EE_EdfStartSaving(UInt32 userID, String filename, String patientID, String recordID, String date, String time);
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfStopSaving")]
        static extern Int32 Unmanaged_EE_EdfStopSaving(UInt32 userID);
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfStopSavingAll")]
        static extern Int32 Unmanaged_EE_EdfStopSavingAll();
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "EE_EdfSsetReserve")]
        static extern Int32 Unmanaged_EE_EdfSetReserve(UInt32 bits);
        ...
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ES_AffectivGetValenceScore")]
        static extern Single Unmanaged_ES_AffectivGetValenceScore(IntPtr state);
        ...
        [DllImport("edk.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ES_AffectivGetValenceModelParams")]
        static extern void Unmanaged_ES_AffectivGetValenceModelParams(IntPtr state, out Double rawScore, out Double minScale, out Double maxScale);
    
        public static Int32 EE_EngineConnect(String security)
        {            
            return Unmanged_EE_EngineConnect(security);
        }
        public static Int32 EE_EngineLocalConnect(String security)
        {
            return Unmanged_EE_EngineLocalConnect(security);
        }
        ...
        public static Int32 EE_EdfStart()
        {
            return Unmanaged_EE_EdfStart();
        }

        public static Int32 EE_EdfStop()
        {
            return Unmanaged_EE_EdfStop();
        }

        public static Int32 EE_EdfSeek(UInt32 sec)
        {
            return Unmanaged_EE_EdfSeek(sec);
        }

        public static Int32 EE_EdfGetTotalTime(UInt32 totalTime)
        {
            return Unmanaged_EE_EdfGetTotalTime(totalTime);
        }

        public static void EE_EdfStartSaving(UInt32 userID, String filename, String patientID, String recordID, String date, String time)
        {
            Unmanaged_EE_EdfStartSaving(userID, filename, patientID, recordID, date, time);
        }

        public static void EE_EdfStopSaving(UInt32 userID)
        {
            Unmanaged_EE_EdfStopSaving(userID);
        }

        public static void EE_EdfStopSavingAll()
        {
            Unmanaged_EE_EdfStopSavingAll();
        }

        public static void EE_EdfSetReserve(UInt32 bits)
        {
            Unmanaged_EE_EdfSetReserve(bits);
        }
        ...
        public static Single ES_AffectivGetValenceScore(IntPtr state)
        {
            return Unmanaged_ES_AffectivGetValenceScore(state);
        }
         ...
         public static void ES_AffectivGetEngagementBoredomModelParams(IntPtr state, out Double rawScore, out Double minScale, out Double maxScale)
        {
         ...
         public static void ES_AffectivGetValenceModelParams(IntPtr state, out Double rawScore, out Double minScale, out Double maxScale)
         {
             Unmanaged_ES_AffectivGetValenceModelParams(state, out rawScore, out minScale, out maxScale);
         }
    }
}
