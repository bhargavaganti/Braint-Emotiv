...
namespace Emotiv
{
    ...
    public class EmoEngine
    {
        ...
        /// <summary>
        /// Initializes the connection to EmoEngine. This function should be called at the beginning of programs that make use 
        /// of EmoEngine, most probably in initialization routine or constructor.
        /// </summary>       
        public void Connect()
        {
        ...
        /// <summary>
        /// Initializes the local connection to Input EDF File. This function should be called at the beginning of programs 
        /// that make use of EDF File, most probably in initialization routine or constructor.
        /// </summary>
        /// <param name="szInputFilename">The EDF File what is connected</param>
        public void LocalConnect(string szInputFilename)
        {
            errorHandler(EdkDll.EE_EngineLocalConnect(szInputFilename));
            OnEmoEngineConnected(new EmoEngineEventArgs(UInt32.MaxValue));
        }

        /// <summary>
        /// Record EEG Data to EDF file.
        /// </summary>
        ...
        {
            EdkDll.EE_EdfStartSaving(userId, szInputFilename, patientID, recordID, date, time);
        }

        /// <summary>
        /// Stop Recording EEG Data to EDF file.
        /// </summary>
        public void StopSavingEEGData()
        {
            EdkDll.EE_EdfStopSavingAll();
        }

        /// <summary>
        /// Load EEG Data from EDF file.
        /// </summary>
        public void LoadDatafromEDF()
        {
            EdkDll.EE_EdfStart();
        }
